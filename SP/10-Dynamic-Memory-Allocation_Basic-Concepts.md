...
- `p0`가 가리키는 block의 크기가 5였음을
- `P0`가 가리키는 word를 읽어 봄으로써 사이즈를 읽어내 deallocate할 수 있다.
...
![Format of allocated and free blocks](10/Untitled_9.png)
